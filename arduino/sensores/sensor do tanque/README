...
- Foto do sensor:
  ![Sensor de Combustível](arduino/sensores/sensor do tanque/sensor.jpg)
...
O código-fonte pode ser encontrado no arquivo `potenc_sensor_tanque_com_filtro_deslizante.ino` nesta pasta.
